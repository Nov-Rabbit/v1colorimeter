...
namespace Colorimeter_Config_GUI
{
    ...
    {
        public FrmSetting(List<TestItem> allItems, Fixture fixture, Config config)
        {
            InitializeComponent();
        ...
        {
            cbSFC.Checked = config.IsShopfloor; //isCheckShopfloor;
        }

        private void cbSFC_CheckedChanged(object sender, EventArgs e)
        {
            config.IsShopfloor = cbSFC.Checked;
            //isCheckShopfloor = cbSFC.Checked;
        }
